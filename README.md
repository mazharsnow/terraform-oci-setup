...
This repository contains Terraform code to manage Oracle Cloud Infrastructure (OCI) resources. The configuration files help in setting up and managing an OCI environment using **Terraform**.
